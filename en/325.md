...
Our first lines of [Perl](http://perltricks.com/learn) are:
...
Perl can print a specific char if you now the correct number in a byte written hexadecimaly. And let's translate upper chars to get lower ones too. So we cook this:
...
Now the last and crucial `sub print_panels`:
...
We [output bytes](perldoc.perl.org/PerlIO.html) because this is a data file:
...
Look, what we've just made!

![SPECTRUM display showing classes](d/display2.jpg)
